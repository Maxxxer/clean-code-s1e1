...
listItem.classList.add('item')
    ...
    label.className='input-container__task';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="input-container__checkbox";
    editInput.type="text";
    editInput.className="input-container__input";
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.input-container__input');
    var label=listItem.querySelector(".input-container__task");
...
//select ListItems children
    ...
    var checkBox=taskListItem.querySelector(".input-container__checkbox");
